...
Actualmente estoy en el segundo año de la carrera de Ingeniería de Ejecución en Computación e Informática en la Universidad del Bio-Bio (UBB) y, en paralelo sigo creando proyectos de forma autónoma para seguir fortaleciendo mis conocimientos y habilidades en el área del desarrollo de software.
...
export const biography = {
  ...
  stack: {
    ...
    devTools: ["Git", "VSCode", "CI/CD", "Docker"],
  },
